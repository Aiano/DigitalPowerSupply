...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_Pin|ST7789_BL_Pin|GT911_INT_Pin|GT911_RES_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ST7789_RST_Pin|ST7789_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = GT911_RES_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GT911_RES_GPIO_Port, &GPIO_InitStruct);
